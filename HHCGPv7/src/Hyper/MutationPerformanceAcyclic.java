 ...
 */
public class MutationPerformanceAcyclic
{
        ...
        public MutationPerformanceAcyclic (int noOfFitnessValues)
        {
        ...
        public void setAMutationFitnessValue(AcyclicCoordinates parent, AcyclicCoordinates offspring, int gapSinceLastUpgrade)
        {
                  ...
                  { */
                      if (!offspring.hasActiveNodeBeenChanged(parent))
                      {
                            if (offspring.getAFitnessValue(0) <= parent.getAFitnessValue(0))
                            {
                                ...
                                {
                                    mutationFitnessValue = MutationPerformanceAcyclic.EXCELLENT_PERFORMANCE;
                                    counterPerformance[4] ++;
                                }
                                else 
                                {
                                    mutationFitnessValue = MutationPerformanceAcyclic.GOOD_PERFORMANCE;
                                    counterPerformance[3] ++;
                                }
                            }
                            else 
                            {
                                mutationFitnessValue = MutationPerformanceAcyclic.STATIC_PERFORMANCE;
                      ...
                      else if (gapSinceLastUpgrade >= (3 * this.mutationFitnessValues.length)) 
                      {
                            ...
                            mutationFitnessValue = MutationPerformanceAcyclic.TERRIBLE_PERFORMANCE; 
                            counterPerformance[0] ++;
                      }
                      else 
                      {
                          mutationFitnessValue = MutationPerformanceAcyclic.POOR_PERFORMANCE;
       ...
       //       System.out.println(" **** " + this.g + " " + this.getCurrentValueOfCounter() + " " + counter);
        ...
        public boolean hasATerriblePerformance()
        {
            ...
            return (Arrays.binarySearch(this.mutationFitnessValues, MutationPerformanceAcyclic.TERRIBLE_PERFORMANCE) > -1);
